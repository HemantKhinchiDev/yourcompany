                  ...
                  {props.testimonials.map(({text, imageSrc, name, username})=> (
                    <div className="card mt-6">
                      ...
                      <div className="flex items-center gap-2 mt-5">
                        <Image src={imageSrc} alt={name} className="h-10 w-10 rounded-full" width={40} height={40}/>
    ...
    <section className="bg-white">
      <div className="container">
        <div className="section-heading">
          ...
          <p className="section-discirption mt-5">From intuitve design to powerful features, our app has become an essentital tool for user arround the world.</p>
        </div>
